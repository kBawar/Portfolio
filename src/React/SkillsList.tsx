...
const SkillsList = () => {
  ...
  const skills = {
    'NASA 3D/VR/AR Intern': [
      ...
      'Developer Intern @ Graphics & Visualization Lab (<a href="https://www1.grc.nasa.gov/facilities/gvis/" target="_blank" class="text-[var(--sec)] underline hover:text-[var(--white-icon)]">GVIS</a>)',
      'Public and technical educational outreach to local communities',
    ],
    'Rutgers Involvement': [
      'Women in Computer Science (<a href="https://wics.rutgers.edu" target="_blank" class="text-[var(--sec)] underline hover:text-[var(--white-icon)]">WiCS</a>) Outreach Director',
      'Rutgers Association of Philippine Students (<a href="https://www.rapsawesome.org/eboard" target="_blank" class="text-[var(--sec)] underline hover:text-[var(--white-icon)]">RAPS</a>) Webmaster',
      'Data Structures Learning Assistant (<a href="https://learningcenters.rutgers.edu/student-employment-training/learning-assistant-program" target="_blank" class="text-[var(--sec)] underline hover:text-[var(--white-icon)]">LA</a>)',
    ],
    'Recent Experiences': [
      '<a href="https://ghc.anitab.org/" target="_blank" class="text-[var(--sec)] underline hover:text-[var(--white-icon)]">#GHC24</a> | Grace Hopper Celebration WiCS Scholarship Attendee',
      '<a href="https://douglass.rutgers.edu/wise/super" target="_blank" class="text-[var(--sec)] underline hover:text-[var(--white-icon)]">SUPER</a> Research Experience Computer Graphics Research Assistant',
      'Academy Software Foundation Summer Learning Program (<a href="https://www.aswf.io/summer-learning-program/" target="_blank" class="text-[var(--sec)] underline hover:text-[var(--white-icon)]">ASWF SLP</a>) Learner',
    ]
  };
  ...
  return (
    <div className="text-left pt-3 md:pt-9">
      <h3 className="text-[var(--white)] text-3xl md:text-4xl font-semibold md:mb-6">Currently...</h3>
                ...
                <ul className="space-y-2 text-[var(--white-icon)] text-sm">
                  {items.map((item, index) => (
                    <div key={index} className="flex items-center">
                      ...
                      <li className="pl-3" dangerouslySetInnerHTML={{ __html: item }}></li>
                    </div>
                  ))}
                </ul>
              </div>
